...
typedef Uniform::Sqrt3T <MeshDef> Sqrt3;
typedef Uniform::LoopT <MeshDef> Loop;
typedef Uniform::InterpolatingSqrt3LGT <MeshDef> InterpolatingSqrt3LG;
typedef Uniform::ModifiedButterflyT <MeshDef> ModifiedButterfly;
...
template < typename Subdivider >
//int mainT( size_t _n, 
int subdivideFromToFile ( size_t _n,
